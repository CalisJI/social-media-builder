...
export default function TermsOfService() {
  return <main className={styles.page}>
    ...
    <article className={styles.article}>
      ...
      <section><h2>Agreement</h2><p>By using Social Media Builder, you agree to these terms. If you do not agree, do not use the service.</p></section>
      ...
      <section><h2>Limitation of liability</h2><p>To the extent permitted by law, Social Media Builder is not liable for indirect, incidental, special, or consequential losses resulting from use of the service.</p></section>
      <section><h2>Contact</h2><p>Questions about these terms can be sent to <a href="mailto:quythi.gpt@gmail.com">quythi.gpt@gmail.com</a>.</p></section>
    </article>
  </main>;
}
