...
export default function TermsOfService() {
  return <main className={styles.page}>
    ...
    <article className={styles.article}>
      ...
      <section><h2>Third-party platforms</h2><p>Publishing depends on connected social platforms. Their terms, availability, review processes, and technical limits also apply. We do not control those services.</p></section>
