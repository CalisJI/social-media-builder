...
export default function PrivacyPolicy() {
  return <main className={styles.page}>
    ...
    <article className={styles.article}>
      ...
      <section><h2>Overview</h2><p>Calis Content operates Social Media Builder, a service that helps users prepare and publish their own content to social platforms. This policy explains what information the service processes and why.</p></section>
      ...
      <section><h2>Connected-platform data</h2><p>Authorization data from a connected platform is used to connect the account selected by the user and perform actions the user explicitly requests. Access can be revoked from that platform&apos;s account settings.</p></section>
      ...
      <section><h2>Your choices</h2><p>You may disconnect a social account, revoke platform authorization, or request deletion of service data by contacting <a href="mailto:support.calis@chillpickle.org">support.calis@chillpickle.org</a>.</p></section>
